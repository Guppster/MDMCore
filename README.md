...
[![Build Status](https://travis-ci.org/gsingh/MDMCore.svg?branch=master)](https://travis-ci.org/gsingh/MDMCore)
...
6. If you did everything correct, https://gsingh.github.io/MDMCore/ will lead to your new docs
...
- Documentation(ReDoc): https://gsingh.github.io/MDMCore/
- SwaggerUI: https://gsingh.github.io/MDMCore/swagger-ui/
- Look full spec:
    + JSON https://gsingh.github.io/MDMCore/swagger.json
    + YAML https://gsingh.github.io/MDMCore/swagger.yaml
- Preview spec version for branch `[branch]`: https://gsingh.github.io/MDMCore/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://gsingh.github.io/MDMCore/ with url from the message: `Server started <url>`
